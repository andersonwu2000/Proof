...
class area:
    def __init__(self, bases=set(), axioms=set()) -> None:
        """
        Parameters
            bases (set of areas): 該領域的基礎領域
            axioms  (set of str): 該領域的所有公理或基本假設
        Variables
            self.theorems (dict of str&AST): 該領域的所有定理
            self.bases       (set of areas): 該領域的基礎領域
            self.ancestor    (set of areas): 該領域的所有基本領域
        """
